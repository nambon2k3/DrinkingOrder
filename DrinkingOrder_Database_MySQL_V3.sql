...
CREATE TABLE `orderdetail` (
  ...
  `ProductDetailID` INT DEFAULT NULL,
  `ToppingID` longtext DEFAULT NULL, -- Hoặc giữ là LONGTEXT nếu cần lưu trữ nhiều topping
  `IsDeleted` TINYINT DEFAULT 0,
  `CreatedAt` DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3),
  `CreatedBy` INT DEFAULT NULL,
  `Quantity` INT DEFAULT NULL,
...
CREATE TABLE `post` (
  ...
  `CreatedAt` DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3),
  `CreatedBy` INT DEFAULT NULL,
  `ImgURL` longtext DEFAULT NULL, -- Chỉ cần lưu một URL
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `productdetail` (
  ...
  `ImageURL` longtext DEFAULT NULL, -- Chỉ cần lưu một URL
...
CREATE TABLE `role` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `Name` VARCHAR(50) NOT NULL, -- Đảm bảo tên vai trò không null
  `IsDeleted` TINYINT DEFAULT 0,
  `CreatedAt` DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3),
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `settings` (
  `ID` INT NOT NULL AUTO_INCREMENT,
  `Type` VARCHAR(50) NULL, -- Đảm bảo Type không null
  `Value` VARCHAR(150) DEFAULT NULL,
  `Order` INT DEFAULT NULL, -- Đổi tên Order để tránh nhầm lẫn
  `CreatedBy` INT DEFAULT 1,
  `IsDeleted` TINYINT DEFAULT 0,
  `Description` LONGTEXT DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
CREATE TABLE `topping` (
  ...
  `LastUpdated` DATETIME(3) DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
