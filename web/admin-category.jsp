                            ...
                            <form action="category" method="post">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id="updateCategoryName" value="${category.categoryName}" pattern=".*\S.*" required title="Địa chỉ không được trống hay chỉ khoảng trắng">
                                    </div>
                                    <div class="form-group">
                ...
                <div class="modal-content">
                    <form action="category" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="categoryName">Tên</label>
                                <input type="text" class="form-control" name="name" pattern=".*\S.*" required title="Địa chỉ không được trống hay chỉ khoảng trắng">
                            </div>
                            <div class="form-group">
                                <label for="isDeleted">Trạng thái</label>
                                <select class="form-control" id="isDeleted" name="isDeleted">
