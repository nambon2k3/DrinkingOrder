                    ...
                    <tbody>
                        ...
                        <c:forEach var="product" items="${orderedProducts}">
                            <tr>
                                ...
                                <td>$${product.discount != null &&  product.discount != 0 ? (product.price * (100-product.discount)/100)*(product.buyQuantity) + totalTopping: product.price*product.buyQuantity + totalTopping}</td>
                                <td>
                                    ...
                                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#productInfoModal_${product.orderDetailId}">Info</button>
                                    <div class="modal fade" id="productInfoModal_${product.orderDetailId}" tabindex="-1" role="dialog" aria-labelledby="productInfoModalLabel_${product.orderDetailId}" aria-hidden="true">
                                        <!-- Modal Content -->
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <!-- Modal Header -->
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="productInfoModalLabel_${product.orderDetailId}">Product Details</h5>
